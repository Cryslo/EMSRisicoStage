...
public class DirectoryBox
{
  #region Variables
	...
	public string ParentDirectoryName {
		set{ this.parentDirectoryName = value;}
		get{ return this.parentDirectoryName;}
	}
	...
	{
		if(fileMode) {
			Debug.Log(directoryName + " in " + parentDirectoryName);
			GameManager.SetGameState(GameState.Play, parentDirectoryName, directoryName);
		} else {
